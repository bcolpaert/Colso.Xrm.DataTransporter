...
namespace Colso.DataTransporter.AppCode
{
    ...
    {
        internal static EntityMetadata GetEntityMetadata(this IOrganizationService service, string logicalname, EntityFilters filters)
        {
        ...
        internal static string RetrieveAttributeDisplayName(this IOrganizationService oService, EntityMetadata emd, string attributeName, string fetchXml)
        {
            ...
            if (attributeName.Contains("."))
            {
                ...
                {
                    EntityMetadata relatedEmd = oService.RetrieveEntity(rEntityName);
        ...
        /// </summary>
        /// <returns></returns>
        internal static List<EntityMetadata> RetrieveEntities(this IOrganizationService oService)
        {
        ...
        /// </summary>
        /// <returns></returns>
        internal static List<ManyToManyRelationshipMetadata> RetrieveAssociations(this IOrganizationService oService)
        {
        ...
        internal static EntityMetadata RetrieveEntity(this IOrganizationService oService, string logicalName)
        {
            try
            {
